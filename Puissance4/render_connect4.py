...
if __name__=="__main__":
    j=input("Jouer a puissance 4 ou 5: Saisissez (4 ou 5)")
    if j=="4":
        J=input("Saisissez le nombre de joueurs: (1 ou 2) ")
        if J=="2":
            g = initialise(6,7)
            p=1
            winn = False
            ...
            D=input("Saisissez la difficulté (1 ou 2)")
            if D=="1":
                g = initialise(6,7)
                p=1
                winn = False
